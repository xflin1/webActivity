...
const TABLE = 'serviceDataTarget';
var TABLE_FIELDS = ['vid','sd']; //表字段
...
module.exports = {
     ...
     * @returns {bluebird}
     */
    getBySd:function(sd, fields){
        return base.getBaseMulti(TABLE,{sd:sd},fields);
    },
    getByVid:function(vid){
        var query = sqlCmd.getVendorFather;
        return base.baseQuery(query,[vid]);
    }
};
